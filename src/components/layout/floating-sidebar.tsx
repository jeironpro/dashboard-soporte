  ...
  return (
    <div ref={rootRef} className="relative">
      <nav
        ...
        data-sidebar
        className="fixed left-3 top-3 bottom-3 z-40 flex flex-col overflow-hidden rounded-[20px] border border-border bg-paper-0 shadow-[0_8px_40px_-12px_rgba(20,30,80,0.12),0_0_0_1px_rgba(20,30,80,0.04)] backdrop-blur-xl transition-[width] duration-300"
